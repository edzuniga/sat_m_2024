...
class ActualizarFamiliaFormulario extends StatefulWidget {
  ...
  @override
  State<ActualizarFamiliaFormulario> createState() =>
      _ActualizarFamiliaFormularioState();
}

class _ActualizarFamiliaFormularioState
    extends State<ActualizarFamiliaFormulario> {
  ...
  //Cargar los miembros migrantes
  @override
  void initState() {
    //_cargarFamiliaMiembros();
    super.initState();
  }
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownSencillo(
                        valorInicial: (familiasProvider.idDepartamento != 0)
                            ? familiasProvider.idDepartamento.toString()
                            : null,
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.patrocinio != 0)
                            ? familiasProvider.patrocinio.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.sexo != 0)
                            ? familiasProvider.sexo.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'sexo_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.estudia != 0)
                            ? familiasProvider.estudia.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.educacion != 0)
                            ? familiasProvider.educacion.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.estado != 0)
                            ? familiasProvider.estado.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    (condicionesProvider.condicionNinaNino)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.ambosPadres !=
                                          0)
                                      ? familiasProvider.ambosPadres.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p01 != 0)
                            ? familiasProvider.p01.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p01_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p02 != 0)
                            ? familiasProvider.p02.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p02_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p03 != 0)
                            ? familiasProvider.p03.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p03_familias',
                    ...
                    MultiSelectDialogField(
                      initialValue: familiasProvider.opcionesActP04,
                    ...
                    const SizedBox(height: 7),
                    MultiSelectDialogField(
                      initialValue: familiasProvider.opcionesActP05,
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p06 != 0)
                            ? familiasProvider.p06.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p06_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p07 != 0)
                            ? familiasProvider.p07.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p07_familias',
                    ...
                    const SizedBox(height: 7),
                    MultiSelectDialogField(
                      initialValue: familiasProvider.opcionesActP08,
                      confirmText: Text(
                        'ACEPTAR',
                        style:
                            GoogleFonts.lato(color: kTextoAzul, fontSize: 14),
                      ),
                      cancelText: Text(
                        'CANCELAR',
                        style:
                    ...
                    (condicionesProvider.condicion8)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p09 != 0)
                                      ? familiasProvider.p09.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p09_familias',
                    ...
                    const SizedBox(height: 7),
                    MultiSelectDialogField(
                      initialValue: familiasProvider.opcionesActP10,
                      confirmText: Text(
                        'ACEPTAR',
                        style:
                            GoogleFonts.lato(color: kTextoAzul, fontSize: 14),
                    ...
                    (condicionesProvider.condicion10)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p11 != 0)
                                      ? familiasProvider.p11.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p11_familias',
                              ...
                              const SizedBox(height: 7),
                              MultiSelectDialogField(
                                initialValue: familiasProvider.opcionesActP12,
                                confirmText: Text(
                                  'ACEPTAR',
                                  style: GoogleFonts.lato(
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p13 != 0)
                                      ? familiasProvider.p13.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p13_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p14 != 0)
                            ? familiasProvider.p14.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p14_familias',
                    ...
                    (condicionesProvider.condicionP14)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p16 != 0)
                                      ? familiasProvider.p16.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p16_familias',
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p17 != 0)
                                      ? familiasProvider.p17.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p17_familias',
                              ...
                              (condicionesProvider.condicionP17)
                                  ? Column(
                                      ...
                                      children: [
                                        ...
                                        const SizedBox(height: 15),
                                        Text(
                                            '18b. ¿Número de veces que ha sido deportado/a USA?',
                                            style: GoogleFonts.lato(
                                                fontSize: 14,
                                                color: Colors.black54)),
                                        const SizedBox(height: 7),
                                        ...
                                        DropdownSencillo(
                                            valorInicial:
                                                (familiasProvider.p19 != 0)
                                                    ? familiasProvider.p19
                                                        .toString()
                                                    : null,
                                            placeholder: 'Seleccione...',
                                            caso: 'p19_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p20 != 0)
                            ? familiasProvider.p20.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p20_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p21 != 0)
                            ? familiasProvider.p21.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p21_familia',
                    ...
                    (condicionesProvider.condicionP20y21)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p22 != 0)
                                      ? familiasProvider.p22.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p22_familia',
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p23 != 0)
                                      ? familiasProvider.p23.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p23_familia',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p24 != 0)
                            ? familiasProvider.p24.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p24_familia',
                    ...
                    (condicionesProvider.condicionP24)
                        ? Column(
                            ...
                            children: [
                              Text(
                                  '27. ¿De las personas de este hogar ha fallecido o desaparecido durante su viaje?',
                                  style: GoogleFonts.lato(
                                      fontSize: 14, color: Colors.black54)),
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p27 != 0)
                                      ? familiasProvider.p27.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p27_familia',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p28 != 0)
                            ? familiasProvider.p28.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p28_familia',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p29 != 0)
                            ? familiasProvider.p29.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p29_familia',
                    ...
                    (condicionesProvider.condicionP29)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p30 != 0)
                                      ? familiasProvider.p30.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p30_familia',
                              ...
                              const SizedBox(height: 7),
                              MultiSelectDialogField(
                                initialValue: familiasProvider.opcionesActP31,
                                confirmText: Text(
                                  'ACEPTAR',
                                  style: GoogleFonts.lato(
                                      color: kTextoAzul, fontSize: 14),
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p32 != 0)
                                      ? familiasProvider.p32.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p32_familia',
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p33 != 0)
                                      ? familiasProvider.p33.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p33_familia',
                    ...
                    (condicionesProvider.condicionP14y24)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p34 != 0)
                                      ? familiasProvider.p34.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p34_familia',
                              ...
                              const SizedBox(height: 7),
                              MultiSelectDialogField(
                                initialValue: familiasProvider.opcionesActP35,
                                confirmText: Text(
                                  'ACEPTAR',
                                  style: GoogleFonts.lato(
                                      color: kTextoAzul, fontSize: 14),
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p36 != 0)
                                      ? familiasProvider.p36.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p36_familia',
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p37 != 0)
                                      ? familiasProvider.p37.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p37_familia',
                              ...
                              (condicionesProvider.condicionP37)
                                  ? Column(
                                      ...
                                      children: [
                                        ...
                                        DropdownSencillo(
                                            valorInicial:
                                                (familiasProvider.p38 != 0)
                                                    ? familiasProvider.p38
                                                        .toString()
                                                    : null,
                                            placeholder: 'Seleccione...',
                                            caso: 'p38_familia',
                                        ...
                                        DropdownSencillo(
                                            valorInicial:
                                                (familiasProvider.p39 != 0)
                                                    ? familiasProvider.p39
                                                        .toString()
                                                    : null,
                                            placeholder: 'Seleccione...',
                                            caso: 'p39_familia',
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p40 != 0)
                                      ? familiasProvider.p40.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p40_familia',
                              ...
                              (condicionesProvider.condicionP40)
                                  ? Column(
                                      ...
                                      children: [
                                        Text(
                                            '41. Si ha decidido viajar a Estados Unidos, ¿Qué lo haría quedarse en Honduras?',
                                            style: GoogleFonts.lato(
                                                fontSize: 14,
                                                color: Colors.black54)),
                                        const SizedBox(height: 7),
                                        DropdownSencillo(
                                            valorInicial:
                                                (familiasProvider.p41 != 0)
                                                    ? familiasProvider.p41
                                                        .toString()
                                                    : null,
                                            placeholder: 'Seleccione...',
                                            caso: 'p41_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p42 != 0)
                            ? familiasProvider.p42.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p42_familias',
                    ...
                    (condicionesProvider.condicionNinaNino)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p43 != 0)
                                      ? familiasProvider.p43.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p43_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p44 != 0)
                            ? familiasProvider.p44.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p44_familias',
                    ...
                    (widget.idPais == 1)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (familiasProvider.p45 != 0)
                                      ? familiasProvider.p45.toString()
                                      : null,
                                  placeholder: 'Seleccione...',
                                  caso: 'p45_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.vivienda != 0)
                            ? familiasProvider.vivienda.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p46 != 0)
                            ? familiasProvider.p46.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p46_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p47 != 0)
                            ? familiasProvider.p47.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p47_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p48 != 0)
                            ? familiasProvider.p48.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p48_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p49 != 0)
                            ? familiasProvider.p49.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p49_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.p50 != 0)
                            ? familiasProvider.p50.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'p50_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi1 != 0)
                            ? familiasProvider.ppi1.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi1_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi2 != 0)
                            ? familiasProvider.ppi2.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi2_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi3 != 0)
                            ? familiasProvider.ppi3.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi3_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi4 != 0)
                            ? familiasProvider.ppi4.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi4_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi5 != 0)
                            ? familiasProvider.ppi5.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi5_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi6 != 0)
                            ? familiasProvider.ppi6.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi6_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi7 != 0)
                            ? familiasProvider.ppi7.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi7_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi8 != 0)
                            ? familiasProvider.ppi8.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi8_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi9 != 0)
                            ? familiasProvider.ppi9.toString()
                            : null,
                        placeholder: 'Seleccione...',
                        caso: 'pppi9_familias',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (familiasProvider.ppi10 != 0)
                            ? familiasProvider.ppi10.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    //--------------puntaje de PROPENSIÓN A LA MIGRACIÓN
                    ...
                    Container(
                      ...
                      child: Text('Puntaje Obtenido: 0.65',
                          style: GoogleFonts.lato()),
                    ),
                    const SizedBox(height: 15),
                    ...
                    DropdownSencillo(
                        valorInicial:
                            (familiasProvider.facilitador.text.isNotEmpty)
                                ? familiasProvider.facilitador.text
                                : null,
                        placeholder: 'Seleccione...',
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            if (_llave.currentState!.validate()) {
                              ...
                              await DatabaseSatM.instance
                                  .actualizarFamilias(FamiliasModelo(
                                codaleaSatfamilias: widget.codaleaRecibido,
                              ...
                              //Borrar los miembros migrantes para volver a
                              //agregarlos
                              await DatabaseSatM.instance
                                  .borrarFamiliasMiembrosPorCodaleaFamilia(
                                      widget.codaleaRecibido);
