...
class ActualizarMiembrosMigrantes extends StatefulWidget {
  const ActualizarMiembrosMigrantes(
  ...
  @override
  State<ActualizarMiembrosMigrantes> createState() =>
      _FormularioComunidadesState();
}

class _FormularioComunidadesState extends State<ActualizarMiembrosMigrantes> {
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.retornado != 0)
                            ? miembrosMigrantesProvider.retornado.toString()
                            : null,
                    ...
                    (condicionesProvider.condicion0)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 7),
                              DropdownSencillo(
                                  valorInicial: (miembrosMigrantesProvider
                                              .temporalidad !=
                                          0)
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.comunidad != 0)
                            ? miembrosMigrantesProvider.comunidad.toString()
                            : null,
                        placeholder: 'Seleccione...',
...
//-----------------SECCIÓN A INFORMACIÓN PERSONAL ----------------------------//
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.genero != 0)
                            ? miembrosMigrantesProvider.genero.toString()
                            : null,
                        placeholder: 'Seleccione...',
...
//-----------------SECCIÓN C INFORMACIÓN DEMOGRÁFICA ----------------------------//
                    ...
                    DropdownSencillo(
                        valorInicial:
                            (miembrosMigrantesProvider.idDepartamento != 0)
                    ...
                    DropdownSencillo(
                        valorInicial:
                            (miembrosMigrantesProvider.nivelEducativo != 0)
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.estadoCivil !=
                                0)
                            ? miembrosMigrantesProvider.estadoCivil.toString()
                            : null,
                        placeholder: 'Seleccione...',
...
//-----------------SECCIÓN D INFORMACIÓN SOBRE LA MIGRACIÓN --------------------//
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.p09 != 0)
                            ? miembrosMigrantesProvider.p09.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.p10 != 0)
                            ? miembrosMigrantesProvider.p10.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.p11 != 0)
                            ? miembrosMigrantesProvider.p11.toString()
                            : null,
                        placeholder: 'Seleccione...',
...
//-----------------SECCIÓN E INFORMACIÓN SOBRE LA FAMILIA DE LA PERSONA QUE MIGRÓ --------------------//
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.p12 != 0)
                            ? miembrosMigrantesProvider.p12.toString()
                            : null,
                        placeholder: 'Seleccione...',
...
//-----------------SECCIÓN F AL ENCUESTADO --------------------//
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.p13 != 0)
                            ? miembrosMigrantesProvider.p13.toString()
                            : null,
                        placeholder: 'Seleccione...',
...
//-----------------SECCIÓN G CONDICIONES DE MIGRACIÓN --------------------//
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.p14 != 0)
                            ? miembrosMigrantesProvider.p14.toString()
                            : null,
                        placeholder: 'Seleccione...',
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.p15 != 0)
                            ? miembrosMigrantesProvider.p15.toString()
                            : null,
                        placeholder: 'Seleccione...',
...
//-----------------SECCIÓN H EXPECTATIVAS Y PLANES FUTUROS --------------------//
                    ...
                    const SizedBox(height: 7),
                    DropdownSencillo(
                        valorInicial: (miembrosMigrantesProvider.p16 != 0)
                            ? miembrosMigrantesProvider.p16.toString()
                            : null,
                        placeholder: 'Seleccione...',
                          ...
                          onPressed: () async {
                            ...
                            if (_llave.currentState!.validate()) {
                              ...
                              await DatabaseSatM.instance
                                ...
                                codaleaMiembros: widget.codaleaBoleta,
