...
class FormularioComunidades extends StatefulWidget {
  ...
  @override
  State<FormularioComunidades> createState() => _FormularioComunidadesState();
}

class _FormularioComunidadesState extends State<FormularioComunidades> {
  //Llave del formulario
  final _llave = GlobalKey<FormState>();

//---------PARA LA FIRMA
  // INICIAR EL CONTROLADOR DE LA FIRMA
  ...
  //FUNCIONES PROPIAS PARA LA FIRMA
  Future<void> exportImage(BuildContext context) async {
    final Uint8List? data =
        await _controladorFirma.toPngBytes(height: 200, width: 400);
    if (data == null) {
      return;
    }

    //Grabar la imagen en memoria y guardar path en el provider de sign
    await guardarArchivo(data).then((val) {
      var comunidadesProvi =
          Provider.of<SatmComunidadesProvider>(context, listen: false);

      comunidadesProvi.valorSign = val;
    });
  }
//---------PARA LA FIRMA
                  ...
                  children: [
                        ...
                        Checkbox(
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              if (value) {
                                providerComunidades.valorAcepta = 1;
                                condicionesProvider.valorCondicionAcepta = true;
                              } else {
                                providerComunidades.valorAcepta = 0;
                    ...
                    Container(
                      ...
                      child: IconButton(
                          tooltip: 'Rehacer',
                          onPressed: () {
                            setState(() => _controladorFirma.clear());
                          },
                    ...
                    (condicionesProvider.condicionAcepta)
                        ? Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 15),
                              Text(
                                  '16. ¿El jefe/a de familia actualmente está trabajando?:',
                                  style: GoogleFonts.lato(
                                      fontSize: 14, color: Colors.black54)),
                              const SizedBox(height: 7),
                              DropdownSencillo(
                    ...
                    Center(
                      child: ElevatedButton(
                          ...
                          onPressed: (condicionesProvider.condicionAcepta)
                              ? () async {
                                  if (_controladorFirma.isNotEmpty) {
                                    //Función que guarda la firma y obtiene el path
                                    await exportImage(context);

                                    //Guardar en BD
                                    if (_llave.currentState!.validate()) {
                                      await DatabaseSatM.instance
                                          .agregarComunidades(ComunidadesModelo(
                                        ...
                                        idMunicipio:
                                            providerComunidades.idMunicipio!,
                                        comunidad:
                                            providerComunidades.comunidad!,
                                        acepta: providerComunidades.acepta,
                                        sign: providerComunidades.sign.text,
                                        nomEncuestado: providerComunidades
                                            .nomEncuestado.text,
                                        telEncuestado: providerComunidades
                                            .telEncuestado.text,
                                        identidad:
                                            providerComunidades.identidad.text,
                                        edad: int.parse(
                                            providerComunidades.edad.text),
                                        ...
                                        anoCursado: (providerComunidades
                                                ...
                                                providerComunidades
                                                        .anoCursado.text !=
                                                    "")
                                            ? int.parse(providerComunidades
                                                .anoCursado.text)
                                            : 0,
                                        estado: providerComunidades.estado,
                                        nino: int.parse(
                                            providerComunidades.nino.text),
                                        ambosPadres:
                                            providerComunidades.ambosPadres,
                                        nnPatrocinado:
                                            providerComunidades.nnPatrocinado,
                                        idPatrocinio: providerComunidades
                                            .idPatrocinio.text,
                                        ...
                                        facilitador: providerComunidades
                                            .facilitador.text,
                                        telFacilitador: int.parse(
                                            providerComunidades
                                                .telFacilitador.text),
                                        fecha: providerComunidades.fecha.text,
                                        observaciones: providerComunidades
                                            .observaciones.text,
                                    ...
                                    Fluttertoast.showToast(
                                        msg: "La firma no puede quedar vacía!!",
                                        toastLength: Toast.LENGTH_SHORT,
                                        gravity: ToastGravity.CENTER,
                                        timeInSecForIosWeb: 1,
